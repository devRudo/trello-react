...
class SingleBoard extends React.Component {
    ...
    render() {
        ...
        return (
            <Link href="/boards/:boardId" className="col-md-2">
                <div className={`card shadow text-dark mb-3 board ${notAllowed}`} id={this.props.id}>
                    <div className="card-body d-flex justify-content-center align-items-center">
                        ...
                        {this.state.showDelete ? (<div className="position-absolute btn shadow-sm btn-primary deleteBoardDiv rounded-lg" onClick={(e) => this.props.deleteBoard(e)}>
