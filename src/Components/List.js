                        ...
                        <li>
                            <div className="card shadow text-dark mb-3 rounded-lg">
                                <div className="card-header p-2 rounded-lg">
                                    <ListHeader listName={this.state.list.name} deleteList={() => { this.props.deleteList(this.state.list.id) }} />
                                    <ul className="list-group" id="listcard">
                                        {this.state.cards ?
                                            this.state.cards.map(card => <Card key={card.id} id={card.id} deleteCard={this.deleteCard} />)
                                            : null}
                                    </ul>
